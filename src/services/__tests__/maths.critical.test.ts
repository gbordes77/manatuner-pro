...
import type { ColorRequirement, DeckConfiguration, MonteCarloParams } from '../../types/maths'
...
describe('Advanced Math Engine - Frank Karsten Methodology', () => {
  ...
  describe('Frank Karsten Turn Analysis', () => {
    ...
    it('should provide accurate Karsten recommendations', () => {
      ...
      const better = advancedMathEngine.calculateKarstenProbability(60, 18, 3, 2, true, 7)
  ...
  describe('Performance and Caching', () => {
    it('should cache results for identical calculations', () => {
      ...
      // Cached result should be no slower than the first calculation.
      // We avoid a strict "2x faster" assertion because both calls are
      // sub-millisecond and timer resolution makes the ratio unreliable.
      expect(time2).toBeLessThanOrEqual(time1 + 1) // Cached should be at most ~1ms slower (timer jitter)
    })
  ...
  describe('Error Handling', () => {
    it('should handle invalid parameters gracefully', () => {
      ...
      const result2 = advancedMathEngine.calculateKarstenProbability(60, 70, 3, 1, true, 7)
    ...
    it('should validate Monte Carlo parameters', async () => {
      ...
      const result = await advancedMathEngine.runMonteCarloSimulation(invalidParams)
