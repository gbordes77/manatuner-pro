...
const AnalyzerPage: React.FC = () => {
  ...
  const runProbabilityValidation = () => {
    ...
    tests.forEach((test) => {
      ...
      console.log(
        `   Écart: ${Math.abs((actual - test.expected) * 100).toFixed(1)}%`,
      );
  ...
  return (
    ...
    >
      ...
      <Box sx={{ mb: isMobile ? 2 : 4, textAlign: "center" }}>
        ...
        >
          Analyze your manabase with the precision of Frank Karsten's
          mathematics
        </Typography>
      </Box>
      ...
      >
        ...
        <Grid
          item
          xs={12}
          lg={analysisResult && isDeckMinimized ? 2 : isMobile ? 12 : 6}
        >
          <Paper
            sx={{
              p: isMobile ? 2 : 3,
                    ...
                    <Button
                      ...
                      onClick={() => {
                        ...
                        setSnackbar({
                          open: true,
                          message:
                            "🗑️ Interface cleared! Ready for new deck analysis.",
                          severity: "info",
                        });
                      }}
                      sx={{
        ...
        <Grid
          item
          xs={12}
          lg={analysisResult && isDeckMinimized ? 10 : isMobile ? 12 : 6}
        >
          <Paper
            sx={{
              p: isMobile ? 2 : 3,
              ...
              cursor:
                analysisResult && !isDeckMinimized ? "pointer" : "default",
              transition: "all 0.3s ease-in-out",
              "&:hover":
                analysisResult && !isDeckMinimized
                  ? {
              ...
              <div data-testid="analysis-results">
                ...
                <TabPanel value={activeTab} index={0}>
                  ...
                  >
                    {MANA_COLORS.map((color) => {
                      const count =
                        analysisResult.colorDistribution[color] || 0;
                  ...
                  <Box sx={{ display: "flex", alignItems: "center", gap: 2 }}>
                    ...
                    <Typography variant="body1">
                      Consistency:{" "}
                      {(analysisResult.consistency * 100).toFixed(1)}%
                    </Typography>
                  </Box>
                </TabPanel>
                  ...
                  <EnhancedCharts
                    analysis={{
                      ...
                      overallScore: Math.round(
                        analysisResult.consistency * 100,
                      ),
                      consistency: Math.round(analysisResult.consistency * 100),
                      colorScrew: Math.round(
                        (1 - analysisResult.consistency) * 20,
                      ), // Estimate
                      ...
                      probabilities: {
                        turn1: {
                          ...
                          specificColors:
                            analysisResult.probabilities.turn1.specificColors,
                          multipleColors: {},
                        },
                        turn2: {
                          anyColor: analysisResult.probabilities.turn2.anyColor,
                          specificColors:
                            analysisResult.probabilities.turn2.specificColors,
                          multipleColors: {},
                        },
                        turn3: {
                          anyColor: analysisResult.probabilities.turn3.anyColor,
                          specificColors:
                            analysisResult.probabilities.turn3.specificColors,
                          multipleColors: {},
                        },
                        turn4: {
                          anyColor: analysisResult.probabilities.turn4.anyColor,
                          specificColors:
                            analysisResult.probabilities.turn4.specificColors,
                          multipleColors: {},
                        },
                        overall: {
                ...
                <TabPanel value={activeTab} index={2}>
                  ...
                  <Typography
                    ...
                    sx={{ mb: 3 }}
                  >
                    Real-time mana costs from Scryfall with probability
                    calculations
                  </Typography>
                  ...
                  {deckList.trim() ? (
                    ...
                    <Box sx={{ textAlign: "center", py: 4 }}>
                      <Typography variant="body1" color="text.secondary">
                        No deck list available. Please enter a deck list and
                        analyze it first.
                      </Typography>
                    </Box>
                  )}
                  ...
                  <Box sx={{ mt: 3 }}>
                    <Typography variant="body2" color="text.secondary">
                      💡 P1 = Perfect scenario (all lands on curve) | P2 =
                      Realistic probability (accounts for mana screw)
                    </Typography>
                  </Box>
                </TabPanel>
                ...
                <TabPanel value={activeTab} index={5}>
                  ...
                  <Box sx={{ mt: 3 }}>
                    <Typography variant="body2" color="text.secondary">
                      🔍 Cards are automatically linked to Scryfall for detailed
                ...
                <TabPanel value={activeTab} index={6}>
                  ...
                  <Typography
                    ...
                    sx={{ mb: 3 }}
                  >
                    Detailed analysis of your land base and mana production
                    capabilities. Click on any land name to view it on Scryfall.
                  </Typography>
                    ...
                    <Grid item xs={12} md={6}>
                      <Paper sx={{ p: isMobile ? 2 : 3 }}>
                        ...
                        {(() => {
                          ...
                          const totalMana = colorData.reduce(
                              ...
                              {colorData.length > 0 ? (
                                ...
                                <Box sx={{ textAlign: "center", py: 4 }}>
                                  <Typography
                                    ...
                                    color="text.secondary"
                                  >
                                    No mana requirements detected. This might be
                                    a colorless deck or the analysis needs more
                                    data.
                                  </Typography>
                                </Box>
                              )}
                  ...
                  <Box sx={{ mt: isMobile ? 2 : 3, px: isMobile ? 1 : 0 }}>
                    ...
                    >
                      🏔️ This manabase analysis helps you understand your land
                      distribution and mana production capabilities for optimal
                      deck performance.
                    </Typography>
                  </Box>
                </TabPanel>
      ...
      >
        <Alert
          onClose={() => setSnackbar({ ...snackbar, open: false })}
          severity={
            snackbar.severity as "success" | "warning" | "error" | "info"
          }
          sx={{ width: "100%" }}
        >
          {snackbar.message}
