...
export const DashboardTab: React.FC<DashboardTabProps> = memo(({ analysisResult, isMobile }) => {
  ...
  const health = useMemo(() => {
    if (consistencyPercent >= 85)
      return { label: 'Excellent', color: 'success', icon: <CheckIcon /> }
    if (consistencyPercent >= 70) return { label: 'Good', color: 'primary', icon: <TrendingIcon /> }
    if (consistencyPercent >= 55)
      return { label: 'Average', color: 'warning', icon: <WarningIcon /> }
                    ...
                    title={
                      <Box sx={{ p: 0.5 }}>
                        ...
                        <Typography variant="caption" component="div" sx={{ mb: 1 }}>
                          This score uses hypergeometric probability to measure your deck's ability
                          to cast spells on curve. The same math behind Frank Karsten's famous mana
                          tables.
                        </Typography>
                        ...
                        <Typography variant="caption" component="div">
                          • Color sources vs requirements
                        </Typography>
                        <Typography variant="caption" component="div">
                          • Land ratio for your CMC
                        </Typography>
                        <Typography variant="caption" component="div">
                          • Multi-color consistency
                        </Typography>
                        <Typography variant="caption" component="div" sx={{ mt: 1 }}>
                          <strong>≥85%</strong> Excellent | <strong>≥70%</strong> Good |{' '}
                          <strong>≥55%</strong> Average
                        </Typography>
                      </Box>
                    }
                    arrow
            ...
            <Grid item xs={12} md={8}>
              <Box sx={{ px: isMobile ? 0 : 2 }}>
                ...
                >
                  Consistency Score
                  <Tooltip
                    title="Consistency measures the probability of having the right mana colors to cast your spells on curve. A higher score means your manabase reliably produces the colors you need."
                    arrow
                  >
                    <IconButton size="small" sx={{ ml: 0.5, p: 0 }}>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6}>
                    ...
                    >
                      Average CMC
                      <Tooltip
                        title="CMC (Converted Mana Cost), now called Mana Value, is the total amount of mana needed to cast a spell. For example, a spell costing {2}{U}{U} has a CMC of 4."
                        arrow
                      >
                        <IconButton size="small" sx={{ ml: 0.5, p: 0 }}>
                          <HelpOutlineIcon fontSize="small" sx={{ fontSize: 14, opacity: 0.7 }} />
          ...
          <Card sx={{ textAlign: 'center', height: '100%' }}>
            <CardContent sx={{ py: isMobile ? 1.5 : 2 }}>
              ...
              >
                Avg CMC
                <Tooltip
                  title="CMC (Converted Mana Cost), now called Mana Value, is the total amount of mana needed to cast a spell."
                  arrow
                >
                  <IconButton size="small" sx={{ ml: 0.5, p: 0 }}>
                    <HelpOutlineIcon fontSize="small" sx={{ fontSize: 14, opacity: 0.7 }} />
        ...
        <CardContent>
          ...
          <Box sx={{ display: 'flex', gap: 1.5, flexWrap: 'wrap', mt: 2 }}>
            {MANA_COLORS.map((color) => {
              ...
              const total = Object.values(analysisResult.colorDistribution).reduce(
                (a, b) => a + b,
                0
              )
