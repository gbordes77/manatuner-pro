...
[![Version](https://img.shields.io/badge/Version-2.6.0-blue)](https://github.com/gbordes77/manatuner/releases)
...
| **Reading Library**        | 48 curated MTG resources in **5 tracks** (First FNM / RCQ / Pro Tour / 👑 Commander Pod / 📦 Limited). Full-text search, URL-stateful multi-axis filters, localStorage reading progress + bookmarks (privacy-first), per-article deep-links. 31 live + 13 archive.org recoveries + 4 mirrors. |
